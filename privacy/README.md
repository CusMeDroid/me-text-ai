...
<p>At Me Text AI, accessible from https://cusmedroid.github.io/me-text-ai/, one of our main priorities is the privacy of our visitors. This Privacy Policy document contains types of information that is collected and recorded by Me Text AI and how we use it.</p>
<p>Permissions required :</p>
<ul>
  <li>Our application requires <b>Camera</b> permission to capture the screen to be converted into text display</li>
  <li>Our application requires <b>Microphone</b> permission to voice the screen to be converted into text display</li>
  <li>Our application requires <b>Location</b> permission to current location the screen to be converted into text display</li>
</ul>
